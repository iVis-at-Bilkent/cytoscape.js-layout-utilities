...
var layoutUtilities = function (cy, options) {
   ...
   * polygonwise is true by default so the algorithm looks how well the free cells (outside the polyomino) is used
   */
  instance.packComponents = function (components, randomize = true, polygonwise = true) {
